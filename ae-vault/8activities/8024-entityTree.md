...
Currently entities reside in a tree keyed by channel, as that was the base case, with synchronous access supported by various maps held by an atom. Simpler instead to put all entities into a single tree under an atom and place appropriate restrictions on access.