...
(defn -main
  ...
  (try
    (let [env
          ...
          (k/create-entity env
                           {"param-NAME"        "ROOT+context-SYS"
                            "param_map-DESCRIPTORS^descriptor" {"SYS+descriptor_map-REQUESTS^requestid$str" {"SYS+requestid-REGISTERentity"     ["REGISTER_ENTITYoperationid"]
